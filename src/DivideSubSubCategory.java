 ...
 */
public class DivideSubSubCategory implements TopTitle {
    private String subCategory;
    private String topSubCategoryTitle;
    private DivideSubCategory parent;

    public DivideSubSubCategory(DivideSubCategory divideSubCategory, String subCategory) {
        this.setSubCategory(subCategory);
        this.parent = divideSubCategory;
    }
    ...
    public void setTopSubSubCategoryTitle(String topSubCategoryTitleIn) {
